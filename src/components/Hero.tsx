...
const Hero = () => {
  const [isLeadFormOpen, setIsLeadFormOpen] = useState(false);
          ...
          <h1 className="font-['Montserrat'] text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-tight text-black">
            Your <span className="font-script text-[#FF2D96]">Boutique</span> AI Receptionists & Sales Agents — Always On, Always Polished
  const closeLeadForm = () => {
    setIsLeadFormOpen(false);
  };
          <p className="text-lg md:text-xl lg:text-2xl mb-12 max-w-5xl mx-auto leading-relaxed font-semibold text-black">
            Your boutique AI receptionists are designed to bring personality to every interaction. They answer calls, qualify leads, send reminders, and fill up your schedule 24/7.
    <>
